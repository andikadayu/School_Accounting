<header class="main-header">
	...
	<a href="" class="logo">
		...
		<span class="logo-lg"><b>School-</b>Accounting</span>
	</a>
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<?php 
							if($_SESSION['profile'] == null || $_SESSION == ''){
								...
								echo '<img src="../image/admin/'.$_SESSION["profile"].'" class="user-image" alt="User Image">';
							}
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header">
							...
							<p>
								...
								<small>School Accounting Administrator</small>
							</p>
						</li>
						<!-- Menu Footer-->
						<li class="user-footer">
							<div class="pull-right">
								<button class="klik_menu btn btn-default btn-flat" id="logout">Sign out</button>
							</div>
						</li>
					</ul>
				</li>
